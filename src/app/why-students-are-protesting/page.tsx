    ...
    <div>
      ...
      <section className="py-12">
        <Container>
          ...
          <div className="relative mt-8 space-y-0">
            <div className="absolute top-3 left-[17px] h-[calc(100%-24px)] w-2 bg-black" />
            {TIMELINE_ITEMS.map((item, i) => (
              <div key={item.label} className="relative flex gap-5 pb-8 last:pb-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-0.5 text-sm leading-relaxed text-black/80">{item.description}</p>
                  <Link
                    href="/videos"
      ...
      <section className="py-12">
        <Container>
          ...
          <p className="mt-2 text-sm leading-relaxed text-black/80">
            Information on this page is drawn from the following publicly available sources.
          </p>
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {SOURCES.map((source) => (
              ...
              >
                ...
                <p className="mt-1 text-sm leading-relaxed text-black/80">{source.description}</p>
              </a>
            ))}
          </div>
      ...
      <section className="bg-black py-12">
        <Container className="flex flex-col items-center gap-4 text-center">
          <Chakra className="h-12 w-12 invert" />
