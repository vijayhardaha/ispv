 ...
 *
 * @example
 * // When no Vercel env vars are set and PORT is 3001
 ...
 *
 * @example
 * // Assuming siteUrl() returns "https://admin.example.com"
 * getPermaLink("videos") // -> "https://admin.example.com/videos"
 * getPermaLink("/videos") // -> "https://admin.example.com/videos"
 * getPermaLink("/videos/") // -> "https://admin.example.com/videos"
 * getPermaLink("") // -> "https://admin.example.com"
 * getPermaLink("/") // -> "https://admin.example.com"
 */
