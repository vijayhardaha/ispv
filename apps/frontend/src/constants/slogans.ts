...
export const SLOGANS: string[] = [
  ...
  'स्वतंत्रता तब तक जीवित रहती है जब तक आम लोग दूसरी ओर देखने से इनकार करते हैं।',
  'A nation grows stronger when every voice is free to speak.',
  'जब हर आवाज़ बोलने के लिए स्वतंत्र होती है, तो राष्ट्र और मज़बूत बनता है।',
  'The truest patriot protects the rights of every citizen.',
  'सच्चा देशभक्त हर नागरिक के अधिकारों की रक्षा करता है।',
  'Our strength is not in fear, but in freedom.',
  'हमारी शक्ति भय में नहीं, स्वतंत्रता में है।',
  'Democracy lives wherever citizens choose to participate.',
  'लोकतंत्र वहीं जीवित रहता है जहाँ नागरिक भाग लेना चुनते हैं।',
  'The Constitution belongs to all of us.',
  'संविधान हम सभी का है।',
  'Rights are preserved only when people are willing to defend them.',
  'अधिकार तभी सुरक्षित रहते हैं जब लोग उनकी रक्षा के लिए तैयार होते हैं।',
  'The bravest voices are often the peaceful ones.',
  'सबसे बहादुर आवाज़ें अक्सर सबसे शांतिपूर्ण होती हैं।',
  "A peaceful crowd is one of democracy's greatest strengths.",
  'शांतिपूर्ण भीड़ लोकतंत्र की सबसे बड़ी ताकतों में से एक है।',
  'We raise our voices so no one has to raise their fists.',
  'हम अपनी आवाज़ उठाते हैं ताकि किसी को मुक्के न उठाने पड़ें।',
  'India was built by courage, not by silence.',
  'भारत चुप्पी से नहीं, साहस से बना है।',
  'The freedom won yesterday must be protected today.',
  'कल जीती गई स्वतंत्रता की रक्षा आज होनी चाहिए।',
  'Liberty is inherited only when it is defended by every generation.',
  'स्वतंत्रता तभी विरासत में मिलती है जब हर पीढ़ी उसकी रक्षा करती है।',
  'Patriotism begins with caring for one another.',
  'देशभक्ति एक-दूसरे की परवाह करने से शुरू होती है।',
  'Kindness is not weakness. It is the courage to remain human.',
  'दयालुता कमज़ोरी नहीं है। यह इंसान बने रहने का साहस है।',
  'The flag belongs to every citizen equally.',
  'झंडा हर नागरिक का समान रूप से है।',
  'The streets remember what history forgets.',
  'सड़कें वह याद रखती हैं जो इतिहास भूल जाता है।',
  'Every generation writes its own chapter of freedom.',
  'हर पीढ़ी स्वतंत्रता का अपना अध्याय लिखती है।',
  'Peace is not passive. It is an act of courage.',
  'शांति निष्क्रिय नहीं है। यह साहस का कार्य है।',
  'A candle can illuminate what anger never will.',
  'मोमबत्ती वह रोशन कर सकती है जो क्रोध कभी नहीं कर सकता।',
  'History remembers those who stood without hatred.',
  'इतिहास उन्हें याद रखता है जो बिना नफरत के खड़े रहे।',
  'The future belongs to those who care enough to show up.',
  'भविष्य उनका है जो आगे आने की परवाह करते हैं।',
  'Every citizen has a place in the story of India.',
  'हर नागरिक का भारत की कहानी में स्थान है।',
  'The voice of the people is part of the strength of the nation.',
  'जनता की आवाज़ राष्ट्र की शक्ति का हिस्सा है।',
  'Justice begins when people refuse to accept injustice.',
  'न्याय तब शुरू होता है जब लोग अन्याय स्वीकार करने से इनकार करते हैं।',
  'Rights mean little if they are never exercised.',
  'अधिकारों का कोई अर्थ नहीं यदि उनका प्रयोग कभी न हो।',
  'The Republic is strongest when every citizen is heard.',
  'गणतंत्र तब सबसे मज़बूत होता है जब हर नागरिक की बात सुनी जाती है।',
  'Many voices. One Constitution.',
  'अनेक आवाज़ें। एक संविधान।',
  'The greatest movements begin with ordinary people.',
  'सबसे महान आंदोलन आम लोगों से शुरू होते हैं।',
  'India belongs to everyone who believes in its ideals.',
  'भारत उन सभी का है जो इसके आदर्शों में विश्वास रखते हैं।',
];
