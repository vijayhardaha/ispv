...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      'font-body min-h-25 w-full resize-y border-2 border-black bg-white px-3 py-2.5 placeholder:text-black/40 focus:ring-2 focus:ring-yellow-500 focus:outline-none',
      className
    )}
    {...props}
  />
